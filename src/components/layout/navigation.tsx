    ...
    <>
      ...
      >
        ...
        <Link href="/" className="flex items-center gap-4 group">
          ...
          <span className="font-display font-extrabold text-lg tracking-[0.08em] uppercase text-dark-text group-hover:text-accent-amber transition-colors duration-300">
            Seris Loom
          </span>
        </Link>
